...
public class Address {
    ...
    private final static String REGEX = "^(?<street>[A-Za-zÆØÅæøå [[0-9][.s]]]+) (?<house>[0-9]+[A-Za-z]?), (?<floor>[0-9+]?)(?<side>st|th|tv)?|(?<postcode>[0-9]{4})?(?<cityName>[A-Za-zÆØÅæøå]+[ ]?[A-Za-zÆØÅæøå]+)?";
